module bootcamp::stake {
    ...
    public entry fun create_pool<StakeToken, RewardToken>(
        ...
        assert!(admin_address == DEFAULT_ADMIN, ERROR_ONLY_ADMIN);
    ...
    public entry fun deposit<StakeToken, RewardToken>(
        ...
        if (user_info.amount > 0) {
            ...
            if (pending_reward > 0) {
                ...
                transfer::public_transfer(pending_reward_coin, account_address);
    ...
    public entry fun withdraw<StakeToken, RewardToken>(
        ...
        if (amount > 0) {
            ...
            transfer::public_transfer(staked_coin, account_address);
        };
    ...
    public entry fun emergency_reward_withdraw<StakeToken, RewardToken>(
        ...
        transfer::public_transfer(reward_coin, admin_address);
